...
export type OpenAgentsAgentModelInput = GatewayModelId | AgentModelSelection;
...
const callOptionsSchema = z.object({
  ...
  model: z.custom<OpenAgentsAgentModelInput>().optional(),
  subagentModel: z.custom<OpenAgentsAgentModelInput>().optional(),
  customInstructions: z.string().optional(),
  skills: z.custom<SkillMetadata[]>().optional(),
});

export type OpenAgentsAgentCallOptions = z.infer<typeof callOptionsSchema>;
...
function normalizeAgentModelSelection(
  selection: OpenAgentsAgentModelInput | undefined,
...
export const openAgentsAgent = new ToolLoopAgent({
  model: defaultModel,
...
export type OpenAgentsAgent = typeof openAgentsAgent;
